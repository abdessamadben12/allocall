...
const locations = [
    {
        ...
        cardPosition: 'left-[31.5%] top-[24.7%] -translate-y-1/2',
    },
    {
        id: 'maroc',
        label: 'Maroc',
        ...
        cardPosition: 'left-[50%] top-[39%] -translate-y-1/2',
    },
    {
        id: 'france',
        label: 'France',
        ...
        cardPosition: 'left-[30.5%] top-[27.8%] -translate-y-1/2',
    },
];
        ...
        <section className="overflow-hidden bg-white py-20 lg:py-24" onClick={() => setActiveLocation(null)}>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <Reveal className="mx-auto max-w-4xl text-center">
                    <h2 className="text-4xl font-extrabold tracking-normal text-[#111827] uppercase sm:text-5xl">{t('Presence internationale')}</h2>

                    <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-gray-500 sm:text-base lg:text-lg">
                        {t(
                            'Une organisation connectee entre l Amerique du Nord, l Europe et l Afrique pour offrir un service client fluide, rapide et adapte a vos marches.',
                        )}
                    </p>
                </Reveal>
                ...
                <Reveal className="relative mt-12" delay={0.12} y={18}>
                    <div className="relative mx-auto max-w-6xl">
                        ...
                        {activeLocation && (
                            ...
                            >
                                <h3 className="text-sm font-extrabold uppercase sm:text-xl lg:text-2xl">{t(activeLocation.label)}</h3>

                                <p className="mt-2 text-[10px] leading-4 font-medium sm:mt-4 sm:text-xs sm:leading-5 lg:text-sm lg:leading-6">
                                    {t('Sites: ')}
                                    {t(activeLocation.sites)}
                                    <br />
