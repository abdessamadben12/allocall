                ...
                >
                    ...
                    <StaggerItem>
                        <p className="mx-auto max-w-2xl text-base leading-relaxed font-light text-white/75 sm:text-lg">
                            {t("Une equipe telephonique et commerciale a distance pour vos appels, vos ventes, vos rendez-vous et votre relation client.")}</p>
                    </StaggerItem>
                </Stagger>
            ...
            <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-18 lg:px-8">
                <Reveal className="mb-14 space-y-3 text-center">
                    <h2 className="serif-display text-3xl font-bold text-alidade-navy sm:text-4xl">
                        {t("Des services pour chaque besoin client")}</h2>
                </Reveal>

          <Stagger
    stagger={0.1}
    amount={0.05}
    className="grid grid-cols-1 gap-x-10 gap-y-16 sm:grid-cols-2 lg:grid-cols-6"
>
    {serviceOverview.map((service, index) => {
        ...
        return (
            <StaggerItem
                ...
                className={`
                    lg:col-span-2
                    ${isBeforeLast ? 'lg:col-start-2' : ''}
                    ${isLast ? 'lg:col-start-4' : ''}
                `}
            >
                <Link
                        ...
                        <div className="absolute inset-0 transition-transform duration-500 group-hover:scale-110">
                            ...
                            <span
                                className="
                                    ...
                                    rounded-full
                                    bg-[#74B946]
                                    shadow-[0_0_0_5px_rgba(116,185,70,0.12)]
                                "
                            />
                        </div>
...
<div
    className="
        ...
        rounded-full
        bg-[#F7FAF5]
        shadow-[0_10px_35px_rgba(17,24,39,0.06)]
        transition-all
        duration-500
        group-hover:bg-[#74B946]
        group-hover:shadow-[0_15px_40px_rgba(116,185,70,0.25)]
    "
>
    ...
    <div
        className={`{
            ...
            left-1/2
            flex
            ${service.slug === 'prise-rendez-vous' ? 'h-[74px] w-[74px] p-3' : 'h-[62px] w-[62px]'}
            ${service.slug === 'service-clientele' ? 'h-[62px] w-[70px] p-2' : 'h-[62px] w-[62px]'}
            ${service.slug === 'assistance' ? 'h-[62px] w-[70px] p-3    s' : 'h-[62px] w-[62px]'}
    ...
    className={`
        ...
        ${
            service.slug === 'prise-rendez-vous'
                ? 'translate-x-[3px] w-20 h-20'
                : ''
        }

        ${
            service.slug === 'service-clientele'
                ? 'translate-x-[3px] w-20'
                : ''
        }
    `}
    loading="lazy"
