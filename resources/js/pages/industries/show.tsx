            ...
            <main className="public-content">
                <section className="detail-hero" aria-labelledby="detail-title">
                    ...
                    <div className="detail-container detail-hero-content">
                        <Link href="/industries" className="detail-back">
                            <ArrowLeft size={17} aria-hidden="true" /> {t("Toutes les industries")}</Link>
                        <p className="detail-eyebrow">{t("ALLO CALL / ")}{t(page.name)}</p>
                        ...
                        <a href="#prestations" className="detail-button bg-alidade-gold">
                            {t("Découvrir nos services ")}<ArrowRight size={18} aria-hidden="true" />
                        </a>
                    </div>
                </section>
                <div className="detail-benefits">
                    <div className="detail-container">
                        <span>
                            <PhoneIncoming size={22} aria-hidden="true" /> {t("Vos appels pris en charge")}</span>
                        <span>
                            <CalendarCheck size={22} aria-hidden="true" /> {t("Vos rendez-vous suivis")}</span>
                        <span>
                            <Headset size={22} aria-hidden="true" /> {t("Une équipe à vos côtés")}</span>
                    </div>
                </div>
                ...
                <section className="detail-container detail-expertise" aria-labelledby="detail-expertise-title">
                    <div className="detail-expertise-photo">
                        ...
                        />
                        <span>
                            <Headset size={22} aria-hidden="true" /> {t("Des agents qui comprennent votre métier.")}</span>
                    </div>
                    <div>
                    ...
                    <div className="detail-container">
                        ...
                        <ol className="detail-flow" aria-label={t("Parcours de suivi")}>
                            {page.flow.map((step, index) => (
                                <li key={step}>
                                    <span className="detail-flow-number">{t("0")}{index + 1}</span>
                                    <span>{t(step)}</span>
                ...
                <section className="detail-contact" aria-labelledby="detail-contact-title">
                    <div className="detail-container">
                        ...
                        <Link className="detail-related" href={slug === 'automobile' ? '/industries/sante' : '/industries/automobile'}>
                            {t("Découvrir aussi : ")}{slug === 'automobile' ? t("Santé") : t("Automobile")} <ArrowRight size={17} aria-hidden="true" />
                        </Link>
                    </div>
                </section>
            </main>
