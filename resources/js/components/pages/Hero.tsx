        ...
        const slides = [
            {
                ...
                description:
                    "Une équipe téléphonique et commerciale à distance, dédiée aux PME québécoises.\nRéception d'appels, service à la clientèle, télévente, gestion de leads et prise de rendez-vous — sans les coûts d'une équipe interne.",
...

            {
                ...
                title:
                    'VOS LEADS TRAITÉS EN\nQUELQUES MINUTES,\n24 H SUR 24',

                description:
                    "Chatbot, agent vocal IA, SMS automatisés et CRM intelligent travaillent avec nos agents pour qualifier, relancer et convertir vos prospects.\nL'IA gère le volume, nos agents gèrent les conversations qui comptent.",
...

            {
                ...
                description:
                    "Un prospect qui n'est pas rappelé ne revient pas.\nAlloCall prend en charge vos appels entrants, vos relances et votre agenda pour transformer chaque demande en rendez-vous qualifié.",
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        >
                            ...
                            <StaggerItem className="flex items-center gap-4 pt-4 first:pt-0 first:pl-0 sm:pt-0 lg:pl-4">
                                ...
                                <div>
                                    <h3 className="text-xs font-bold whitespace-nowrap tracking-wider text-[#111827] uppercase sm:text-sm">
                                        {t('Appels entrants')}
                                    </h3>
