...
const { t } = useLocale();
    ...
    const handleSubmit = (e: FormEvent) => {
         ...
         * Sauvegarde locale
         */
        const existingQuotesJson =
            localStorage.getItem(
                'allocall_quotes',
            );

        const existingQuotes: QuoteType[] =
            existingQuotesJson
                ? JSON.parse(
                      existingQuotesJson,
                  )
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        >
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-alidade-gold text-sm font-bold tracking-[0.25em] uppercase sm:text-xl">
                                    {t("Solution personnalisée")}</span>
                            </div>

                            <h2 className="text-3xl font-bold uppercase sm:text-4xl lg:text-5xl">
                                {t("Demandez votre")}<br />

                                <span className="text-alidade-gold font-serif">
                                    {t("soumission gratuite")}</span>
                            </h2>

                            <p className="max-w-lg text-sm leading-relaxed font-light text-gray-300 sm:text-base">
                                {t("Parlez-nous de vos besoins en service à la clientèle, appels, ventes ou prise de rendez-vous. Notre équipe vous proposera une solution adaptée à votre volume d'appels, vos objectifs et votre organisation.")}</p>
                            ...
                            <div className="grid grid-cols-1 gap-6 border-t border-white/10 pt-6 sm:grid-cols-3">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span className="block text-xs font-bold tracking-wider uppercase">
                                            {t("Service sur mesure")}</span>

                                        <span className="block text-[10px] font-light text-gray-400">
                                            {t("Adapté à votre entreprise")}</span>
                                    </div>
                                </div>
                            </div>
                        </Reveal>
                        ...
                        >
                            ...
                            >
                                <div className="mb-6">
                                    <h3 className="text-alidade-navy text-lg font-bold tracking-wider uppercase">
                                        {t("Demande de soumission")}</h3>

                                    <p className="mt-2 text-xs leading-relaxed text-gray-500">
                                        {t("Remplissez le formulaire et notre équipe communiquera avec vous pour mieux comprendre vos besoins.")}</p>
                                </div>
                                        ...
                                        <div className="animate-in zoom-in-95 mb-6 space-y-3 rounded-xl border border-emerald-100 bg-emerald-50 p-4 text-emerald-800 duration-300">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-xs font-bold tracking-wider uppercase">
                                                    {t("Demande enregistrée sous le numéro")}{' '}
                                                    {
                                                        submittedQuote.id
                                                    }
                                                </span>
                                            ...
                                            <p className="text-[11px] leading-relaxed font-light text-emerald-700">
                                                {t("Merci pour votre demande. Un membre de l'équipe AlloCall communiquera avec vous afin d'analyser vos besoins et vous proposer une solution adaptée.")}</p>
                                ...
                                >
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="relative">
                                            <select
                                                ...
                                                id="quote-type-input"
                                            >
                                                <option value="Assistante virtuelle">
                                                    {t("Assistante virtuelle")}</option>

                                                <option value="Télévente / appels sortants">
                                                    {t("Télévente / appels sortants")}</option>

                                                <option value="Gestion des leads">
                                                    {t("Gestion des leads")}</option>

                                                <option value="Prise de rendez-vous">
                                                    {t("Prise de rendez-vous")}</option>

                                                <option value="Service à la clientèle">
                                                    {t("Service à la clientèle")}</option>

                                                <option value="Réception téléphonique">
                                                    {t("Réception téléphonique")}</option>

                                                <option value="Support technique niveau 1">
                                                    {t("Support technique niveau 1")}</option>

                                                <option value="Confirmation de rendez-vous">
                                                    {t("Confirmation de rendez-vous")}</option>

                                                <option value="Plusieurs services">
                                                    {t("Plusieurs services")}</option>

                                                <option value="Autre besoin">
                                                    {t("Autre besoin")}</option>
                                            </select>
                                    ...
                                    <div className="space-y-1">
                                        <div className="flex justify-between gap-3">
                                            <label className="block text-[10px] font-bold tracking-widest text-gray-400 uppercase">
                                                {t("Parlez-nous de vos besoins *")}</label>

                                            {preFilledSummary && (
                                                <span className="text-alidade-gold bg-alidade-gold/5 animate-pulse rounded px-2 py-0.5 text-[9px] font-bold">
                                                    {t("Service sélectionné")}</span>
                                            )}
                                        </div>

                                        <div className="relative">
                                            <textarea
                                                placeholder={t("Ex. Nous recevons environ 150 appels par semaine et recherchons une équipe pour répondre aux clients, prendre les rendez-vous et assurer les suivis...")}
                                                required
                                                rows={
                                                    4
                                                }
                                    ...
                                    <div className="space-y-1">
                                        <label className="block text-[10px] font-bold tracking-widest text-gray-400 uppercase">
                                            {t("Budget mensuel estimé (optionnel)")}</label>
                                    ...
                                    <div className="space-y-1">
                                        <label className="block text-[10px] font-bold tracking-widest text-gray-400 uppercase">
                                            {t("Ajouter un document (optionnel)")}</label>
                                        ...
                                        >
                                            ...
                                            <span className="text-[9px] text-gray-400">
                                                {t("Scripts, cahier des charges, liste de besoins ou document de référence")}</span>
                                        </div>
                                    </div>
                ...
                <div className="mx-auto max-w-7xl space-y-16 px-4 sm:px-6 lg:px-8">
                    <Reveal className="space-y-3 text-center">
                        <span className="text-alidade-gold text-xs font-bold tracking-[0.25em] uppercase">
                            {t("Votre partenaire relation client")}</span>

                        <h3 className="text-alidade-navy text-2xl font-bold sm:text-3xl">
                            {t("Pourquoi choisir AlloCall ?")}</h3>
                        ...
                        <p className="mx-auto max-w-2xl text-sm leading-relaxed text-gray-500">
                            {t("Une équipe dédiée pour vous aider à améliorer votre relation client, gérer davantage d'appels et soutenir votre croissance.")}</p>
                    </Reveal>
                    ...
                    >
                        ...
                        <StaggerItem className="space-y-3 rounded-xl border border-gray-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                            ...
                            <h4 className="text-alidade-navy text-xs font-bold tracking-wider uppercase">
                                {t("Analyse de vos besoins")}</h4>

                            <p className="text-xs leading-relaxed font-light text-gray-500">
                                {t("Nous analysons votre volume d'appels, vos objectifs, vos processus et vos besoins afin de définir la solution la mieux adaptée à votre entreprise.")}</p>
                        </StaggerItem>
                        ...
                        <StaggerItem className="space-y-3 rounded-xl border border-gray-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                            ...
                            <h4 className="text-alidade-navy text-xs font-bold tracking-wider uppercase">
                                {t("Solution personnalisée")}</h4>

                            <p className="text-xs leading-relaxed font-light text-gray-500">
                                {t("Scripts, horaires, processus, outils CRM et méthodes de communication sont adaptés à votre entreprise et à votre clientèle.")}</p>
                        </StaggerItem>
                        ...
                        <StaggerItem className="space-y-3 rounded-xl border border-gray-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                            ...
                            <h4 className="text-alidade-navy text-xs font-bold tracking-wider uppercase">
                                {t("Équipe professionnelle")}</h4>

                            <p className="text-xs leading-relaxed font-light text-gray-500">
                                {t("Vos appels et vos clients sont pris en charge avec professionnalisme par une équipe formée pour représenter votre entreprise.")}</p>
                        </StaggerItem>
                        ...
                        <StaggerItem className="space-y-3 rounded-xl border border-gray-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                            ...
                            <h4 className="text-alidade-navy text-xs font-bold tracking-wider uppercase">
                                {t("Accompagnement continu")}</h4>

                            <p className="text-xs leading-relaxed font-light text-gray-500">
                                {t("Nous suivons les performances, ajustons les processus et faisons évoluer le service en fonction de vos besoins.")}</p>
                        </StaggerItem>
                    </Stagger>
                    ...
                    <Reveal className="from-alidade-navy to-alidade-dark border-alidade-gold/15 flex flex-col items-center justify-between gap-6 rounded-2xl border bg-gradient-to-r p-6 text-white shadow-lg sm:p-8 md:flex-row">
                        <div className="space-y-1.5 text-center md:text-left">
                            <span className="text-alidade-gold block text-xs font-bold tracking-widest uppercase">
                                {t("Vous avez des questions ?")}</span>

                            <p className="max-w-xl text-sm font-light leading-relaxed text-gray-300">
                                {t("Discutez avec notre équipe de vos besoins en service client, télévente, gestion des leads, réception d'appels ou prise de rendez-vous.")}</p>
                        </div>
