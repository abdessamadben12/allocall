import{j as e,m as h,af as L,d as x,M as v,Y as O,Q as T,ab as E,ag as $,ah as q,ai as W,F as y,X as P,aj as _}from"./ui-C0Vt0jii.js";import{r as H,$ as p,K as D,L as J}from"./inertia-SOERDnsj.js";const I=[.22,1,.36,1],Q=(n=.12,t=0)=>({hidden:{},visible:{transition:{staggerChildren:n,delayChildren:t}}});function G({children:n,className:t,delay:a=0,y:s=28,amount:r=.2,as:u="div"}){const f=L(),j=h[u];return e.jsx(j,{className:t,initial:{opacity:0,y:f?0:s},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:r},transition:{duration:.7,delay:a,ease:I},children:n})}function V({children:n,className:t,stagger:a=.12,delay:s=0,amount:r=.15}){return e.jsx(h.div,{className:t,initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:r},variants:Q(a,s),children:n})}function Y({children:n,className:t,y:a=28}){const r={hidden:{opacity:0,y:L()?0:a},visible:{opacity:1,y:0,transition:{duration:.65,ease:I}}};return e.jsx(h.div,{className:t,variants:r,children:n})}const c={phone:"05 22 48 44 25",whatsapp:"212668746386",whatsappMessage:"Bonjour Alidade, je souhaite obtenir des informations sur vos services.",email:"contact@alidade.ma",address:"3, Avenue 2 Mars Résidence Marwa 5 ème étage Casablanca, Maroc",mapEmbedUrl:"https://maps.google.com/maps?q=Casablanca%2C%20Maroc&z=12&output=embed",socials:{facebook:"",instagram:"",linkedin:""}};function K(){return`https://wa.me/${c.whatsapp}?text=${encodeURIComponent(c.whatsappMessage)}`}const re="/images/qui-sommes-nous/atelier-finition.webp",ie="/images/qui-sommes-nous/atelier-finition.webp",le="/images/agencement/agencement-et-réaménagement-image-2.webp",oe="/images/revetement-sol/revetement-sol-1.webp",ce="/images/qui-sommes-nous/amenagement.webp",X="/logo_footer.png",de="/images/agencement/décoration_intérieure.webp",me="/images/bannieres/menuiserie-Bois2-final.webp",d={maroc:{phone:"+212 5 22 48 44 25",href:"tel:+212522484425"},montreal:{phone:"+1 514-660-2337",href:"tel:+15146602337"},email:"contact@allocall.ma"},N=[{href:c.socials.facebook,icon:e.jsx($,{size:18}),label:"Facebook"},{href:c.socials.instagram,icon:e.jsx(q,{size:18}),label:"Instagram"},{href:c.socials.linkedin,icon:e.jsx(W,{size:18}),label:"LinkedIn"}].filter(n=>n.href),xe=()=>e.jsxs("footer",{className:"overflow-hidden bg-[#111827] text-white",children:[e.jsxs("div",{className:"flex flex-col items-stretch lg:flex-row",children:[e.jsxs(G,{className:`
                        flex
                        w-full
                        flex-col
                        justify-center
                ...
                `,children:e.jsx("div",{className:`
                    ...
                    `,children:e.jsxs("p",{className:`
                            ...
                            tracking-widest
                            text-gray-500
                        `,children:["© ",new Date().getFullYear()," AlloCall. Tous droits réservés."]})})})]}),w=({icon:n,title:t,description:a,hasBorder:s})=>e.jsxs(Y,{className:`
            flex
            flex-col
            items-center
            p-10
