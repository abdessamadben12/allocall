...
const { t, href } = useLocale();
        ...
        <div className="company-page">
            <section className="company-hero company-contact-hero" aria-labelledby="contact-title">
                ...
                <div className="company-container">
                    ...
                    <p>
                        {t("Vos appels, vos prospects, votre relation client.")}<br />
                        {t("Notre équipe est à votre écoute.")}</p>
                </div>
            </section>
    ...
    {/* Décoration */}
    <div className="absolute left-0 top-10 h-[calc(100%-80px)] w-[3px] rounded-r-full bg-gradient-to-b from-[#74b946] via-[#9acb79] to-transparent" />
    ...
    <div className="mb-8">
        <div className="mb-4 flex items-center gap-3">
            ...
            <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-[#598435]">
                {t("Restons en contact")}</p>
        </div>

        <h2 className="text-[30px] font-bold tracking-[-0.03em] text-[#202722]">
            {t("ALLO ")}<span className="text-[#74b946]">{t("CALL")}</span>
        </h2>

        <p className="mt-3 max-w-[330px] text-sm leading-6 text-[#737c74]">
            {t("Notre équipe est disponible pour répondre à vos questions et vous accompagner dans votre projet.")}</p>
    </div>
    ...
    <div className="space-y-2">
        ...
        >
            ...
            <div className="min-w-0">
                <span className="mb-1 block text-[11px] font-semibold uppercase tracking-[0.08em] text-[#8a938b]">
                    {t("Maroc")}</span>

                <span className="block text-[17px] font-semibold text-[#202722] transition-colors group-hover:text-[#598435]">
                    {t("+212 5 22 48 44 25")}</span>
            </div>
        </a>
        ...
        >
            ...
            <div className="min-w-0">
                ...
                <span className="block break-all text-[17px] font-semibold text-[#202722] transition-colors group-hover:text-[#598435]">
                    {site.email}
                </span>
            </div>
        </a>
        ...
        <div className="flex items-start gap-4 rounded-xl px-3 py-4">
            ...
            <div className="min-w-0">
                ...
                <p className="max-w-[290px] text-[16px] font-semibold leading-7 text-[#202722]">
                    {t(site.address)}
                </p>
            </div>
        </div>
